...
if(CLIENT) then
	language.Add("tool.vermilion2_teleport.name", "Teleport Tool")
	language.Add("tool.vermilion2_teleport.desc", "Teleport yourself somewhere")
	language.Add("tool.vermilion2_teleport.0", "Left Click: teleport. Right Click: teleport through a wall.")
end
