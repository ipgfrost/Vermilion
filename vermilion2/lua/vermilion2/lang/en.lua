...
lang:Add("cmd:checkaddons:description", "Brings up the addon validator again.")
...
lang:Add("cmd:ban:description", "Ban a player")
lang:Add("cmd:ban:syntax", "<name> <time:minutes (can be fractional, or 0 for permaban)> <reason>")
lang:Add("cmd:kick:description", "Kick a player")
lang:Add("cmd:kick:syntax", "<name> <reason>")
lang:Add("cmd:unban:description", "Unban a player")
...
lang:Add("client_settings:opt:skin", "Skin")
...
lang:Add("cmd:tplook:syntax", "[player to move] [player reference]")
lang:Add("cmd:tppos:syntax", "[player] <x> <y> <z>")
lang:Add("cmd:teleport:syntax", "[player to move] <player to move to>")
lang:Add("cmd:goto:syntax", "<player to go to>")
lang:Add("cmd:bring:syntax", "<player to bring>")
lang:Add("cmd:tpquery:syntax", "<player>")
lang:Add("cmd:tpaccept:syntax", "<player>")
lang:Add("cmd:tpdeny:syntax", "<player>")
lang:Add("cmd:speed:syntax", "[player] <speed multiplier>")
lang:Add("cmd:respawn:syntax", "[player]")
lang:Add("cmd:pm:syntax", "<player> <message>")
lang:Add("cmd:r:syntax", "<message>")
lang:Add("cmd:getpos:syntax", "[player]")
lang:Add("cmd:sudo:syntax", "<player> <command>")
lang:Add("cmd:spectate:syntax", "[-entity <entityid>] [-player <player>]") //Note: don't localise -entity and -player
lang:Add("cmd:steamid:syntax", "[player]")
lang:Add("cmd:ping:syntax", "[player]")
lang:Add("cmd:convar:syntax", "<cvar> [value]")
lang:Add("cmd:deaths:syntax", "<player> <deaths>")
lang:Add("cmd:frags:syntax", "<player> <frags>")
lang:Add("cmd:armour:syntax", "<player> <armour>")
lang:Add("cmd:kickvehicle:syntax", "<player>")
lang:Add("cmd:ignite:syntax", "<player> <time:seconds>")
lang:Add("cmd:extinguish:syntax", "<player>")
lang:Add("cmd:random:syntax", "[min] <max>")
lang:Add("cmd:lockplayer:syntax", "<player>")
lang:Add("cmd:unlockplayer:syntax", "<player>")
lang:Add("cmd:kill:syntax", "<player>")
lang:Add("cmd:assassinate:syntax", "<player>")
lang:Add("cmd:ragdoll:syntax", "<player>")
lang:Add("cmd:stripammo:syntax", "<player>")
lang:Add("cmd:flatten:syntax", "<player>")
lang:Add("cmd:launch:syntax", "<player>")
lang:Add("cmd:stripweapons:syntax", "<player>")
lang:Add("cmd:health:syntax", "[player] <health>")
lang:Add("cmd:explode:syntax", "<player> [magnitude:20]")
lang:Add("cmd:setteam:syntax", "<player> <team>")
lang:Add("cmd:slap:syntax", "<player> <times> <damage>")
lang:Add("cmd:stopslap:syntax", "<player>")
lang:Add("cmd:adminchat:syntax", "<msg>")
lang:Add("cmd:gimp:syntax", "<player>")
lang:Add("cmd:mute:syntax", "<player>")
lang:Add("cmd:gag:syntax", "<player>")
...
lang:Add("cmd:jail:syntax", "<player> <jail zone>")
...
lang:Add("cmd:callvote:syntax", "<type> <data>")
...
lang:Add("votes:noperm", "You don't have permission to call this vote.")
